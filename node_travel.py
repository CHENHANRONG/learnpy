...
This also ties up some stuff about recursion and use of generators.
...
It is also worth pointing out that print_all_1 traverses the tree in a depth-first manner, while print_all_2 is width-first. 
